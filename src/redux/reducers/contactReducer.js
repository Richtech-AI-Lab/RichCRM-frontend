import { CREATE_ATTORNEY_FAILURE, CREATE_ATTORNEY_REQUEST, CREATE_ATTORNEY_SUCCESS, CREATE_CONTACT_FAILURE, CREATE_CONTACT_REQUEST, CREATE_CONTACT_SUCCESS, CREATE_REALTOR_FAILURE, CREATE_REALTOR_REQUEST, CREATE_REALTOR_SUCCESS, DELETE_ATTORNEY_SUCCESS, DELETE_CONTACT_SUCCESS, DELETE_REALTOR_SUCCESS, FETCH_ATTORNEY_BY_ID_FAILURE, FETCH_ATTORNEY_BY_ID_REQUEST, FETCH_ATTORNEY_BY_ID_SUCCESS, FETCH_REALTOR_BY_ID_FAILURE, FETCH_REALTOR_BY_ID_REQUEST, FETCH_REALTOR_BY_ID_SUCCESS, GET_CONTACT_BY_KEYWORD_FAILURE, GET_CONTACT_BY_KEYWORD_REQUEST, GET_CONTACT_BY_KEYWORD_SUCCESS, GET_CONTACT_BY_TYPE_FAILURE, GET_CONTACT_BY_TYPE_REQUEST, GET_CONTACT_BY_TYPE_SUCCESS, READ_CASE_BY_CONTACT_FAILURE, READ_CASE_BY_CONTACT_REQ, READ_CASE_BY_CONTACT_SUCCESS, SET_ATTORNEY_EMPTY, SET_CONTACT_CASES_EMPTY, SET_REALTOR_EMPTY, SET_SELECTED_CONTACT, UPDATE_CONTACT_FAILURE, UPDATE_CONTACT_REQUEST, UPDATE_CONTACT_SUCCESS } from "../type";
...
const contactReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case CREATE_REALTOR_REQUEST:
      return { ...state, loading: true, error: null };
    case CREATE_REALTOR_SUCCESS:
      return { ...state, loading: false, realtor: [...state.realtor, action.payload], error: null };
    case CREATE_REALTOR_FAILURE:
      return { ...state, loading: false, error: action.payload };
    case DELETE_REALTOR_SUCCESS:
      return { ...state, loading: false, realtor: state.realtor.filter(item => item.contactId !== action.payload), error: null };
    default:
      return state;
  }
};
