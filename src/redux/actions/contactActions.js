import { CREATE_ATTORNEY_FAILURE, CREATE_ATTORNEY_REQUEST, CREATE_ATTORNEY_SUCCESS, CREATE_CONTACT_FAILURE, CREATE_CONTACT_REQUEST, CREATE_CONTACT_SUCCESS, CREATE_REALTOR_FAILURE, CREATE_REALTOR_REQUEST, CREATE_REALTOR_SUCCESS, DELETE_ATTORNEY_FAILURE, DELETE_ATTORNEY_REQUEST, DELETE_ATTORNEY_SUCCESS, DELETE_CONTACT_FAILURE, DELETE_CONTACT_REQUEST, DELETE_CONTACT_SUCCESS, DELETE_REALTOR_FAILURE, DELETE_REALTOR_REQUEST, DELETE_REALTOR_SUCCESS, FETCH_ATTORNEY_BY_ID_FAILURE, FETCH_ATTORNEY_BY_ID_REQUEST, FETCH_ATTORNEY_BY_ID_SUCCESS, FETCH_REALTOR_BY_ID_FAILURE, FETCH_REALTOR_BY_ID_REQUEST, FETCH_REALTOR_BY_ID_SUCCESS, GET_CONTACT_BY_TYPE_FAILURE, GET_CONTACT_BY_TYPE_REQUEST, GET_CONTACT_BY_TYPE_SUCCESS,READ_CASE_BY_CONTACT_FAILURE,READ_CASE_BY_CONTACT_REQ,READ_CASE_BY_CONTACT_SUCCESS,SET_ATTORNEY_EMPTY,SET_CONTACT_CASES_EMPTY,SET_REALTOR_EMPTY,SET_SELECTED_CONTACT,UPDATE_CONTACT_FAILURE, UPDATE_CONTACT_REQUEST, UPDATE_CONTACT_SUCCESS } from "../type";
...
export const createRealtorRequest = (payload) => ({
    type: CREATE_REALTOR_REQUEST,
    payload
});

export const createRealtorSuccess = (contact) => ({
    type: CREATE_REALTOR_SUCCESS,
    payload: contact,
});

export const createRealtorFailure = (error) => ({
    type: CREATE_REALTOR_FAILURE,
    payload: error,
});

export const deleteRealtorRequest = (payload) => ({
    type: DELETE_REALTOR_REQUEST,
    payload
});

export const deleteRealtorSuccess = (contact) => ({
    type: DELETE_REALTOR_SUCCESS,
    payload: contact,
});

export const deleteRealtorFailure = (error) => ({
    type: DELETE_REALTOR_FAILURE,
    payload: error,
});