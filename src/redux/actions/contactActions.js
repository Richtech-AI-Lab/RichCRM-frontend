...
export const getMultipleTagsContactRequest = (payload) => ({
    type: GET_MULTIPLE_CONTACT_BY_TYPE_REQUEST,
    payload,
});

export const getMultipleTagsContactSuccess = (contact) => ({
    type: GET_MULTIPLE_CONTACT_BY_TYPE_SUCCESS,
    payload: contact,
});

export const getMultipleTagsContactFailure = (error) => ({
    type: GET_MULTIPLE_CONTACT_BY_TYPE_FAILURE,
    payload: error,
});