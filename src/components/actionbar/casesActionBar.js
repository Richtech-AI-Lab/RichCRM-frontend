        ...
        <>
            <div className="flex justify-between items-center mb-6">
                ...
                <div>
                    ...
                    <XButton text="Export" onClick={toggleModal} icon={<RiDownloadLine className="text-base mr-2 inline-block" />} className="bg-primary2 text-sm text-white py-[10px] px-6 rounded-[100px] font-medium ml-4" />
                </div>
