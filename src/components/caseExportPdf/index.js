...
const CaseExportPdf = ({ onClose }) => {
  ...
  const formData = {
    caseType: caseObj?.caseType == 1 ? "SOLD" : "PURCHASE",
    sellerName: caseObj?.caseType == 1 ? client?.firstName : false,
    sellerSSN: caseObj?.caseType == 1 ? client?.ssn : false,
    sellerAddress: caseObj?.caseType == 1 ? client?.addressId : false,
    sellerCell: caseObj?.caseType == 1 ? client?.cellNumber : false,
    sellerWork: caseObj?.caseType == 1 ? client?.workPhone : false,
    buyerName: caseObj?.caseType == 0 ? client?.firstName : false,
    buyerSSN: caseObj?.caseType == 0 ? client?.ssn : false,
    buyerAddress: caseObj?.caseType == 0 ? client?.addressId : false,
    buyerCell: caseObj?.caseType == 0 ? client?.cellNumber : false,
    buyerWork: caseObj?.caseType == 0 ? client?.firstName : false,
